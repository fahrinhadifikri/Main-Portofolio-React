    ...
    <section id="about" className="py-20 bg-slate-50 dark:bg-black text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <div className="w-full px-8 md:px-16">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="md:row-span-2 h-full">
            <ElectricBorder color="#06b6d4" {...electricSettings}>
              <div className="bg-white dark:bg-[#0a0a0a] rounded-[2rem] p-8 h-full flex flex-col justify-between overflow-hidden relative group shadow-xl dark:shadow-2xl">
          ...
          <motion.div variants={itemVariants} className="h-full">
            <ElectricBorder color="#06b6d4" {...electricSettings}>
              <div className="bg-white dark:bg-[#0a0a0a] rounded-[2rem] p-8 h-full flex flex-col justify-center relative overflow-hidden group shadow-xl dark:shadow-xl">
          ...
          <motion.div variants={itemVariants} className="h-full">
            <ElectricBorder color="#22c55e" {...electricSettings}>
              <div className="bg-white dark:bg-[#0a0a0a] rounded-[2rem] p-6 h-full flex flex-col justify-between group shadow-xl dark:shadow-xl relative overflow-hidden">
          ...
          <motion.div variants={itemVariants} className="md:col-span-2 h-full">
            <ElectricBorder color="#22c55e" {...electricSettings}>
              <div className="bg-white dark:bg-[#0a0a0a] rounded-[2rem] p-8 h-full flex flex-col md:flex-row items-center justify-between relative overflow-hidden group shadow-xl dark:shadow-2xl">
